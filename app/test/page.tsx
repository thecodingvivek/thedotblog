        ...
        <div className="banner w-full h-[200px] relative">
            ...
            <div className="absolute flex gap-2 right-0 top-[-40px]">
                ...
                <div className="px-3 h-[35px]  flex cursor-pointer rounded-full bg-[#0A0A0A] border border-[#1F1F1F] gap-2 items-center">
                    <svg width="20px" height="20px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M927.4 273.5v-95.4h-87.9V82.8h-201v95.3h-87.9v95.4h-78.5v-95.4h-88V82.8H183.2v95.3H95.3v95.4H16.7v190.6h78.6v95.4h75.3v95.3H246v95.3h87.9v95.4h100.5v95.3h153.9v-95.3h100.4v-95.4h88v-95.3H852.1v-95.3h75.3v-95.4h78.5V273.5z" fill="#E02D2D" /></svg>
                    <span className="text-[16px]">3</span>
                </div>
            </div>
        </div>
