...
export default function SearchButton ({ initBlogs } : { initBlogs:SanityDocument[]}){
  ...
  return (
    <>
      <div onClick={()=>setClick(true)} className="search pl-[20px] pr-[5px] py-[5px] z-[999] w-full h-12 rounded-full flex items-center justify-between border border-[#1f1f1f] cursor-pointer">
